    ...
    <div
      className={
        router.pathname === "/stores"
          ? "hidden"
          : "text-white w-full h-60 bg-gray-900 hidden md:flex flex-wrap justify-evenly px-4 py-4 mt-20 z-50"
      }
    >
      <div className="">
      ...
      <div className=" ">
        <h2 className=" bg-white rounded-sm font-semibold text-gray-900 text-center w-36">
          Follow Us on
        </h2>
